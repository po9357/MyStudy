...
HashMap<String, String> map = dao.selTime(movieNo, theaterName);
try {
...
while(ite.hasNext()) {
	String timeNo = cnt+"번";
	String stTime = ite.next();
	String endTime = map.get(stTime);
	String time = stTime+ " ~ "+ endTime;
	sendObject.put(timeNo, time);
	cnt++;
//	list.add(time);
}
